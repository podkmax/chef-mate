...
public interface OrderMapper {
    ...
    @Mapping(target = "status", expression = "java(entity != null && entity.getStatus() != null ? entity.getStatus().name() : null)")
    OrderDto toDto(Order entity);

    @Mapping(target = "id", ignore = true)
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    @Mapping(target = "status", expression = "java(mapStatus(dto, entity.getStatus()))")
